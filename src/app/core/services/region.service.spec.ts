...
describe('RegionService', () => {
  ...
  it('should return a region pagination object', () => {
    const expectedPaginationRegion: PaginationModel = new PaginationModel();
    httpClientSpy.get.and.returnValue(of(expectedPaginationRegion));
    service.getRegions().subscribe((pokemonPagination) => {
      expect(pokemonPagination).toEqual(
        expectedPaginationRegion,
        'expected region pagination'
      );
    });
